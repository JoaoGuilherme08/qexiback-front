      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => <div key={index} className="bg-card rounded-xl p-6 shadow-soft hover:shadow-medium transition-base border border-border">
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto text-white">
            ...
            <Link to="/register">
              <Button size="lg" variant="hero-light" className="shadow-medium bg-[#00ea7c] text-[#f4efea]">
                Criar Conta Grátis
              </Button>
            </Link>
          </div>
