...
export const Navbar = ({ userType = null, onLogout }: NavbarProps) => {
  ...
  const userLinks = [
    { path: "/home", label: "Ofertas", icon: Store },
    { path: "/wallet", label: "Carteira", icon: Wallet },
    { path: "/profile", label: "Perfil", icon: User },
  ];

  const storeLinks = [
    { path: "/store/dashboard", label: "Dashboard", icon: Store },
    { path: "/store/products", label: "Produtos", icon: Store },
  ];

  const institutionLinks = [
    { path: "/institution/dashboard", label: "Dashboard", icon: Heart },
    { path: "/institution/profile", label: "Perfil", icon: User },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to={userType ? "/home" : "/"} className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--secondary))] bg-clip-text text-transparent">
              Qexiback
            </span>
          </Link>
